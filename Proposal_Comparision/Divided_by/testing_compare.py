    ...
    for row1 in f1_rows:
        for row2 in f2_rows:
            ...
            for v1, v2 in zip(row1, row2):
                # print(f'{v2} - {v1} = {v2 - v1}')
                try:
                    row_result.append(abs(v2 /v1) <=1.00005)
...
if __name__ == '__main__':
    main(dir1=Path(r'/home/UNT/sd0570/mmdetection/Proposal_Comparision/test1'),
         dir2=Path(r'/home/UNT/sd0570/mmdetection/Proposal_Comparision/test'))