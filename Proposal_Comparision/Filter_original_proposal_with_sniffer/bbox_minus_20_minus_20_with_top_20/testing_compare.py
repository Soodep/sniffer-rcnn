    ...
    for row1 in f1_rows:
        if row1[4] > 0.6:
            for row2 in f2_rows:
                ...
                if all(row_result):
                    result1.append(row1)
    #print("Total Sniffer Proposals:", len(result1))
    return result1

def compare_content1(f1_rows, f2_rows):
    result1 = []
    for row1 in f1_rows:
        for row2 in f2_rows:
            row_result = []
...
def main(dir1, dir2):
    for file_one in dir1.glob('*.txt'):
        ...
        result1 = compare_content1(f1_content1,f2_content)
        #f1_content1 = get_lines1(file_one)
...
if __name__ == '__main__':
    main(dir1=Path(r'/home/UNT/sd0570/mmdetection/Proposal_Comparision/Filter_original_proposal_with_sniffer/bbox_minus_20_minus_20_with_top_20/original'),
         dir2=Path(r'/home/UNT/sd0570/mmdetection/Proposal_Comparision/Filter_original_proposal_with_sniffer/bbox_minus_20_minus_20_with_top_20/sniffer'))
