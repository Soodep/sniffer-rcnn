...
def main(dir1, dir2):
    for file_one in dir1.glob('*.txt'):
        ...
        result1 = compare_content(f2_content)
        print_result(result)
...
if __name__ == '__main__':
    main(dir1=Path(r'/home/UNT/sd0570/mmdetection/Proposal_Comparision/Filter_original_proposal_with_sniffer/all sniffer plus original >0.50/original'),
         dir2=Path(r'/home/UNT/sd0570/mmdetection/Proposal_Comparision/Filter_original_proposal_with_sniffer/all sniffer plus original >0.50/sniffer'))
